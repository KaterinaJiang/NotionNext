...
STARTER_FEATURE_4_BUTTON_URL: 'https://docs.tangly1024.com/about',  // 特性4
  ...
  STARTER_TESTIMONIALS_TEXT_1: 'What customers says',
  STARTER_TESTIMONIALS_TEXT_2:
    'Hundreds of customers choose to use Chinafrica to transport their oods, we help them complete luggage transportation, company procurement, bulk purchase...',
  ...
  STARTER_FAQ_1_QUESTION: 'Can l ship cellphones?',
  STARTER_FAQ_1_ANSWER:
    'We provide cellphone shipping service, but it can only be delivered by Express, and thereis no compensation if it is lost, so we do not recommend that you ship your phone.',

  STARTER_FAQ_2_QUESTION: 'Can l send brand good?',
  STARTER_FAQ_2_ANSWER:
    'Generally speaking, branded products can only be transported by sea (branded productsdo not include luxury goods and well-known brands, such as Nike and Adidas)',

  STARTER_FAQ_3_QUESTION: 'What are your charges?',
  STARTER_FAQ_3_ANSWER:
    'Our fees consist of two parts: shipping and service fees (service fees include customsclearance fees and courier fees within the destination country)',
  ...
  STARTER_BLOG_TEXT_2:
    'Here we will publish the latest news about Chinafrica, including thesituation of international logistics, price changes, new suppliers, etc.',
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/leave-us-a-message-5a5nkj', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
