...
const BLOG = {
  ...
  UUID_REDIRECT: process.env.UUID_REDIRECT || '', // 是否开启UUID跳转，默认关闭
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ChinAfrica', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '-express- Trading And Logistics Company', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.chin-a-frica.store', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ChinAfrica, Trading And Logistics Company', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'chinafrica520@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-8R9B3Q87H8', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'ChinAfrica', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'The most convenient multinational logistics company you can choose', // 站点描述，被notion中的页面描述覆盖
